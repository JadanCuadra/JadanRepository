...
namespace DevTalles.Controllers
{
    public class SubCategoriaController : Controller
    {
        ...
        {
            var ListaSubCategoria = await _db.SubCategorias.ToListAsync();

            return View(ListaSubCategoria);
        }
        ...
        public async Task<ActionResult> Crear(SubCategoria model)
        {
            if (!ModelState.IsValid) { return NotFound(); }

            await _db.SubCategorias.AddAsync(model);
